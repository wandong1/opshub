...
import (
	...
	"github.com/ydcloud-dy/opshub/internal/biz/alert"
...
func (e *PromQLExecutor) queryDataSource(ctx context.Context, ds *alert.AlertDataSource, promql string, queryType string) (string, error) {
	// 构建查询 URL
	var apiPath string
	params := url.Values{}
